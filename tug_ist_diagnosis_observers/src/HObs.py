...
# and publishes the state of the channels whether ON or OFF.
# It publishes this trend of the value overs /observations topic
# compatible for our Model Based Diagnosis.
