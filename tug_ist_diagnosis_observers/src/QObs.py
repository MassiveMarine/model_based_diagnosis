...
# and publishes trend of the message whether value increases, decreases or remains constant.
# It publishes this trend of the value overs /observations topic compatible for our Model Based Diagnosis.
# It needs topic name, value name in the message with all fields separated
# by space, window size(milliseconds).
