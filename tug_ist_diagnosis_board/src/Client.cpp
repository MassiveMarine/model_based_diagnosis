...
void Client::start_stopBroadcasting(int frqy)
{
	  unsigned char frq = (unsigned char) frqy;
    	  delim = 2;
	  printf("function");
          command = 1;
          length = 1;
	  ...
	  memcpy(&nbuffer[sizeof(delim)+sizeof(command)+sizeof(length)], &frq, sizeof(frq));           
